    ...
    <div class="flex-1 bg-card border border-border rounded-md overflow-hidden flex flex-col">
      <div ref="tableBodyRef" class="flex-1 overflow-auto">
        <div class="flex items-center px-4 bg-table-header h-11 shrink-0 sticky top-0 z-10">
          ...
          <span class="w-[140px] text-xs font-semibold text-text-primary text-center">姓名</span>
          <span class="flex-1 text-xs font-semibold text-text-primary text-center">邮箱</span>
          <span class="w-[100px] text-xs font-semibold text-text-primary text-center">订单数</span>
          <span class="w-[100px] text-xs font-semibold text-text-primary text-center">状态</span>
          <span class="w-[180px] text-xs font-semibold text-text-primary text-center">注册时间</span>
          <span class="w-[100px] text-xs font-semibold text-text-primary text-center">操作</span>
        </div>
...
import { ChevronDown, Ban, CheckCircle2 } from 'lucide-vue-next'
